...
% Does not apply to me as I'll just be handing in the PDF.
...
%  \urlstyle{rm}\Url}\fi
%
%\bibitem[{\textit{Brown}(1967)}]{bro1967}
%Brown, R. J.~E. (1967), Permafrost in {Canada}, \textit{Map 1246A}, Geol. Surv.
%  of Can., Ottawa, Ont.
%
%\bibitem[{\textit{Englemann et~al.}(1986)\textit{Englemann, Perkins, Hagan, and
%  Haller}}]{Englemann1986}
%Englemann, R.~J., R.~W. Perkins, D.~I. Hagan, and W.~A. Haller (1986), Washout
%  coefficients for selected gases and particulates, paper presented at 59th
%  Annual Meeting, Air Pollut. Control Agency, San Francisco, Calif., 20--24
%  June.
%
%\end{thebibliography}
